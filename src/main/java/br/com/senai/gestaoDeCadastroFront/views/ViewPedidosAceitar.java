...
public class ViewPedidosAceitar extends JFrame {

	private static final long serialVersionUID = 1L;
	private JPanel contentPane;

	public ViewPedidosAceitar() {
		setResizable(false);
		...
		lblFundo.setIcon(new ImageIcon(ViewPedidosAceitar.class.getResource("/br/com/senai/gestaoDeCadastroFront/img/Tela inicial após ter logado (cliente) (2).png")));
