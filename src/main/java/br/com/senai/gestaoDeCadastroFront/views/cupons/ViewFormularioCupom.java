...
public class ViewFormularioCupom extends JFrame {
	...
	public ViewFormularioCupom() {
		...
		RoundJTextField txtCodigo = new RoundJTextField(0);
		...
		JFormattedTextField txtValidade = new JFormattedTextField(dateFormatter);
		...
		RoundJTextField txtPercentual = new RoundJTextField(0);
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String dataString = LocalDate.parse(txtValidade.getText().toString(), formatterEntrada).format(formatterSaida);
						...
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_contentPane.createParallelGroup(Alignment.TRAILING, false)
									...
									.addComponent(txtCodigo, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 617, Short.MAX_VALUE)
									.addComponent(lblValidade, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addComponent(lblCodigo, Alignment.LEADING))
								.addComponent(btnSalvar, Alignment.TRAILING, GroupLayout.PREFERRED_SIZE, 122, GroupLayout.PREFERRED_SIZE))
							.addGap(356))
						.addGroup(Alignment.TRAILING, gl_contentPane.createSequentialGroup()
